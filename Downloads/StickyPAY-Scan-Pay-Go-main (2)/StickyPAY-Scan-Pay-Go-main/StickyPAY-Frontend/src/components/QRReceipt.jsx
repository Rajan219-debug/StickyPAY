...
export default function QRReceipt({ order: initialOrder }) {
  ...
  return (
    ...
    >
      ...
      {/* 🔥 FULL DETAILS */}
      <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 space-y-2 text-sm">
      ...
      {order?.order_items?.length > 0 && (
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 mt-3 space-y-2 text-sm">
