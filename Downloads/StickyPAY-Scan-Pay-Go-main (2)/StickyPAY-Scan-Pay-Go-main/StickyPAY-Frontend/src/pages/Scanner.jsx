    ...
    const handleScan = async (decodedText) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const currentTotal = currentCart.items.reduce((s, i) => s + i.quantity, 0);
                if (currentTotal >= MAX_CART_ITEMS) {
                    toast.error('Cart limit reached', { description: `You can add up to ${MAX_CART_ITEMS} items in a single order` });
                    setLoading(false);
                    return;
                }
            ...
            {activeStore && (
                <div className="space-y-4">
                    ...
                    {hasItems ? (
                        ...
                        /* Empty state */
                        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-lg">
                            <div className="w-14 h-14 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-4">
